...
```
git clone https://github.com/MozamelJawad/hello-react-front-end.git
...
```
git clone https://github.com/MozamelJawad/hello-rails-back-end.git
...
Back-end API [Link](https://github.com/MozamelJawad/hello-rails-back-end)
...
Feel free to check the [issues page](https://github.com/MozamelJawad/hello-react-front-end/issues).
